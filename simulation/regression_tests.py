...
TEST_CASES = [
    ...
    # ── Subfolder hierarchy не должна добавлять автора как префикс серии ────
    # Папка "Дэай Свок (Day Souok)": скобочный суффикс не должен мешать сравнению
    ("Subfolder hierarchy: скобочный суффикс в папке автора",
     "Воин Справедливости",
     {"proposed_series": "Воин Справедливости"}),

    # Папка "Дубина-Родион (Дарки)": псевдоним в скобках — proposed_author=Дарки
    ("Subfolder hierarchy: псевдоним в скобках папки автора",
     "Путь нечисти\\1.",
     {"proposed_series": "Путь нечисти"}),

    # Папка "Дубовиков-Виталий": паттерн Фамилия-Имя без совпадения меты
    ("Subfolder hierarchy: Фамилия-Имя папка автора",
     "Чит-код Эльминстера",
     {"proposed_series": "Чит-код Эльминстера"}),
]
